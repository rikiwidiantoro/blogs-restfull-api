...
<div class="container">
  ...
  <div class="row justify-content-center">
      <div class="col-md-8">
        <h4 class="text-center">Edit Data Category</h4>
        <form action="/category/{{$datas->id}}" method="POST">
          @method('put')
          @csrf
          <!-- <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="user_id" name="user_id" value="{{$datas->user_id}}">
            </div>
          </div>
          <div class="row mb-3">
